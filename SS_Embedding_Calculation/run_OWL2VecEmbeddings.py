...
if __name__== '__main__':
    ...
    cache_dir='./SS_Embedding_Calculation/cache'
    ...
    #################################### 
    dataset = sys.argv[1]
    pre_entity_file = sys.argv[2]
    sampler = sys.argv[3]
    name_sampler = sys.argv[4]
    ...
    for aspect in aspects:
        kg_file = path_kgs + "_" + aspect + ".owl"
        embeddings = run_OWL2Vec(kg_file,sampler, walker, walk_depth, n_walks,Mix_Type, embed_size,window_arg, iteration, negative_arg, min_count_arg, seed_arg,
                                                               epoch,URI_Doc_arg,Lit_Doc_arg, Mix_Doc_arg, cache_dir, ontology_projection,pre_entity_file,pre_axiom_file,
                                                               pre_annotation_file, pre_train_model)

        embedding_file_path = path_output + aspect + '/Embeddings_' + dataset + '_' + name_sampler + '_skip-gram_wl_' + aspect + '.txt'
