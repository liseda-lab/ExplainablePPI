...
if __name__ == "__main__":
    ...
    list_aspects = [("42SAs", ["virion_part","cellular_anatomical_entity","other_organism_part","biological_phase","biological_regulation","signaling",
               "rhythmic_process","biomineralization","developmental_process","pigmentation","nitrogen_utilization","immune_system_process","reproductive_process","biological_adhesion","localization","metabolic_process",
               "interspecies_interaction_between_organisms","cellular_process","detoxification","multicellular_organismal_process","behavior","reproduction","locomotion","growth","multi-organism_process","response_to_stimulus",
               "intraspecies_interaction_between_organisms","molecular_adaptor_activity","cargo_receptor_activity","small_molecule_sensor_activity","fusogenic_activity","molecular_template_activity","translation_regulator_activity",
               "structural_molecule_activity","antioxidant_activity","molecular_sequestering_activity","molecular_transducer_activity","molecular_carrier_activity","transporter_activity","molecular_function_regulator","binding","catalytic_activity"]),
                    ("52SAs" ,  ["molecular_function_regulator", "antioxidant_activity", "nutrient_reservoir_activity", "molecular_transducer_activity", "small_molecule_sensor_activity", "molecular_template_activity",
    "toxin_activity", "binding", "cargo_receptor_activity", "translation_regulator_activity", "protein_folding_chaperone", "catalytic_activity", "protein_tag", "structural_molecule_activity",
    "molecular_carrier_activity", "fusogenic_activity", "molecular_sequestering_activity","molecular_adaptor_activity", "transporter_activity", "other_organism_part", "virion_part",
    "virion", "cellular_anatomical_entity", "biological_adhesion","localization", "multicellular_organismal_process", "metabolic_process", "cellular_process",
    "developmental_process", "phosphorus_utilization", "signaling", "sulfur_utilization","locomotion", "behavior", "pigmentation", "carbon_utilization", "biological_regulation",
    "biological_phase", "immune_system_process", "growth", "carbohydrate_utilization","reproductive_process", "rhythmic_process", "reproduction", "interspecies_interaction_between_organisms",
    "biomineralization", "detoxification", "multi-organism_process", "nitrogen_utilization","intraspecies_interaction_between_organisms", "response_to_stimulus"]),
                    ("3SAs", ["biological_process", "cellular_component", "molecular_function"])]
    ...
    for n_aspects, aspects in list_aspects:
        path_results = "Prediction/SS/" + n_aspects

        for SSM in SSMs:
            path_file_SS = "SS_Calculation/SS_files/" + n_aspects + '/ss_' + SSM + '.txt'
            run_cross_validation(algorithms, path_file_SS, path_dataset_file, dataset, path_results, n_partition,path_partition, SSM, aspects)
            gc.collect()
        ...
        for embSSM in embSSMs:
            ...
            run_cross_validation(algorithms, path_file_SS, path_dataset_file, dataset, path_results, n_partition,path_partition, embSSM, aspects)
            gc.collect()
